...
⏱️ Countdown timer for fair gesture capture
🤖 AI-based opponent with random decision logic
...
Gestures are classified as Rock, Paper, or Scissors

AI generates a random move

Game logic compares player and AI moves

Results and scores are displayed in real time
